...
public interface IntPairMap extends IntTransformable, IntPairMapGetter {
    ...
    /**
     * Returns a new IntPairMap where the <code>length</code> amount of last elements
     * has been removed.
     * <p>
     ...
     * @return A new IntPairMap instance without the last elements,
    ...
    default IntPairMap skipLast(int length) {
        ...
        return (max < 0)? ImmutableIntPairMap.empty() : slice(new ImmutableIntRange(0, max));
    }
